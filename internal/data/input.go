...
var TheInput = &pxginput.Input{
	Buttons: map[string]*pxginput.ButtonSet{
		...
		"debugExpDrawNum1":   pxginput.NewJoyless(pixelgl.KeyKP1),
		"debugExpDrawNum20":  pxginput.NewJoyless(pixelgl.KeyKP2),
		"debugExpDrawNum100": pxginput.NewJoyless(pixelgl.KeyKP3),
	},
